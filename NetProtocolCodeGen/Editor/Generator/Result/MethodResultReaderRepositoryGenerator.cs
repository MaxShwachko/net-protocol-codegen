...
{
    public class MethodResultReaderRepositoryGenerator
    {
        private const string ClassName = "MethodResultReaderRepository";
            ...
            List<MethodScheme> methodSchemes)
        {
            ...
            var cu = SyntaxFactory.CompilationUnit()
                .AddUsings(UsingDirectivesHolder.Instance.UsingDirectives.MethodResultReaderRepositoryGenerator);
                        ...
                        SyntaxFactory.SeparatedList<BaseTypeSyntax>(
                            new SyntaxNodeOrToken[]{
                                SyntaxFactory.SimpleBaseType(
                                    SyntaxFactory.IdentifierName("IMethodResultReaderRepository")),
                        ...
                        SyntaxFactory.TypeArgumentList(
                            SyntaxFactory.SeparatedList<TypeSyntax>(
                                new SyntaxNodeOrToken[]
                                {
                                    ...
                                    SyntaxFactory.Token(SyntaxKind.CommaToken),
                                    SyntaxFactory.IdentifierName("IMethodResultReader")
                                }))));
        ...
        {
            var method = SyntaxFactory.MethodDeclaration(
                    SyntaxFactory.ParseTypeName("IMethodResultReader"),
            ...
            body = body.AddStatements(SyntaxFactory.ParseStatement("throw new ArgumentException(\"[MethodResultReaderRepository] No method with agentId\" + agentId + \", methodId: \" + methodId);"));
            method = method.WithBody(body);
